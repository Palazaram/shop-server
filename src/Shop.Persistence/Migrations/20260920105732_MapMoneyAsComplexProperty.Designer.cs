...
namespace Shop.Persistence.Migrations
{
    ...
    [Migration("20260920105732_MapMoneyAsComplexProperty")]
    partial class MapMoneyAsComplexProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.AttributeValues.AttributeValue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("AttributeId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_attribute_values_attribute_id_name");

                    b.HasIndex("AttributeId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_attribute_values_attribute_id_slug");
            ...
            modelBuilder.Entity("Shop.Domain.Categories.CategoryAttribute", b =>
                {
            ...
            modelBuilder.Entity("Shop.Domain.ProductAttributes.ProductAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("ix_product_attributes_slug");
            ...
            modelBuilder.Entity("Shop.Domain.Products.ProductAttributeValue", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid")
                        .HasColumnName("product_id");
                    ...
                    b.HasIndex("AttributeValueId")
                        .HasDatabaseName("ix_product_attribute_values_attribute_value_id");
            ...
            modelBuilder.Entity("Shop.Domain.AttributeValues.AttributeValue", b =>
                {
                    b.HasOne("Shop.Domain.ProductAttributes.ProductAttribute", null)
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_attribute_values_product_attributes_attribute_id");
                });
            ...
            modelBuilder.Entity("Shop.Domain.Categories.CategoryAttribute", b =>
                {
                    b.HasOne("Shop.Domain.ProductAttributes.ProductAttribute", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_category_attributes_product_attributes_attribute_id");
            ...
            modelBuilder.Entity("Shop.Domain.Products.ProductAttributeValue", b =>
                {
                    b.HasOne("Shop.Domain.AttributeValues.AttributeValue", null)
                        .WithMany()
                        .HasForeignKey("AttributeValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_attribute_values_attribute_values_attribute_value_id");
